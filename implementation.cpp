 ...
 * @LastEditors: jia
 * @LastEditTime: 2023-05-10 19:32:42
 * @Description: 请填写简介
 */
/*
...
//与BFS相比dijkstra算法将从起点出发的的步数和从起点出发的距离纳入考虑
   ...
   std::unordered_map<Location, double>& cost_so_far)
{
  ...
  cost_so_far[start] = 0; //用于跟踪从起始位置开始的总移动成本
  ...
  while (!frontier.empty()) {
    ...
    for (Location next : graph.neighbors(current)) {
      ...
      //如果该位置从未到达过，我们不会将位置添加到边界，而是如果到该位置的新路径优于先前的最佳路径，我们将添加它。
